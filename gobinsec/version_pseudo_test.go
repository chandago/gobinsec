...
func TestPseudoVersionString(t *testing.T) {
	...
	if pseudoVersion.String() != "v0.0.0-20191109021931-daa7c04131f5" {
		t.Fatalf("bad pseudo version string representation: %s", pseudoVersion.String())
	}
}

func TestPseudoVersionCompare(t *testing.T) {
	p1, _ := NewPseudoVersion("v0.0.0-20191109021931-daa7c04131f5")
	p2, _ := NewPseudoVersion("v0.0.0-20191109021931-daa7c04131f5")
	r, err := p1.Compare(p2)
	if err != nil {
	...
	p2, _ = NewPseudoVersion("v0.0.0-20191108021931-daa7c04131f5")
	r, err = p1.Compare(p2)
	if err != nil {
		t.Fatalf("performing comparison: %v", err)
	}
	...
	p2, _ = NewPseudoVersion("v0.0.0-20191110021931-daa7c04131f5")
	r, err = p1.Compare(p2)
	if err != nil {
		t.Fatalf("performing comparison: %v", err)
	}
